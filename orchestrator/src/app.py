...
db_channel = grpc.insecure_channel('books-database:50051')
...
order_executor_channel = grpc.insecure_channel('order-executor:50055')
...
# def check_user_data_for_fraud(user, order_id):
...
# def check_credit_card_for_fraud(credit_card, order_id):
...
# def verify_credit_card_format(request_data, order_id):
...
#         return response.is_valid, response.message, updated_vector_clock
# def verify_mandatory_user_data(request_data, order_id):
...
# def enqueue_order(order_id, user_id, book_titles):    
...
order_executor_stub = order_executor_pb2_grpc.OrderExecutorStub(order_executor_channel)
